...
var basis = {
  created() {
    let config = this.$quickTableConfig || {};
    // table
      ...
      slots.forEach(v => {
        ...
        if (slot && condition) {
          if (typeof slot === "function") {
            ...
            scopedSlots[name] = scoped =>
              this.$scopedSlots[slot]({ ...scoped });
          }
        }
      });
      return scopedSlots;
  ...
  methods: {
    ...
    virtualScrollUpdate() {
      ...
      setTimeout(() => {
        ...
        let fixedWrapper = el.querySelector(
          ".el-table__fixed .el-table__fixed-body-wrapper"
        );
        let rightFixedWrapper = el.querySelector(
          ".el-table__fixed-right .el-table__fixed-body-wrapper"
        );
        let warppers = [warpper, fixedWrapper, rightFixedWrapper].filter(
          v => v
        );
...
var merge = {
  created() {
    const merge = Object.assign(mergeProps$1(), this.value.merge || {});
    if (this.value.merge) {
      ...
      directives: [
        {
          name: "loading",
          rawName: "v-loading",
          value: _vm.value.loading,
          expression: "value.loading"
        }
      ],
      ref: "container",
      staticClass: "quick-table",
      style: { height: _vm.styles.containerHeight }
    },
    [
      _c("div", { staticClass: "quickOper" }, [_vm._v("\n    快捷操作9\n  ")]),
      _vm._v(" "),
      _c(
        "el-table",
        _vm._g(
          _vm._b(
            {
              ...
              attrs: { data: _vm.data, height: _vm.styles.tableHeight },
              scopedSlots: _vm._u(
                [
                  {
                    key: "append",
      ...
      _vm._v(" "),
      _vm.value.page && _vm.value.page.enable
        ? _c(
            "el-pagination",
            _vm._g(
              _vm._b(
                { ref: "page", style: { height: _vm.styles.pageHeight } },
                "el-pagination",
                _vm.value.page,
                false
              ),
...
__vue_component__.install = (Vue, installOptions = {}) => {
